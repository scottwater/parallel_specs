...
RSpec.configure do |config|
  ...
  config.after do
    %w[
      ...
      PARALLEL_SPECS_FULL_RERUN_COMMANDS
      PARALLEL_SPECS_GROUPS
      PARALLEL_SPECS_HEARTBEAT_INTERVAL
      PARALLEL_SPECS_PID_FILE
      PARALLEL_SPECS_RERUN_COMMAND_CHAR_LIMIT
      PARALLEL_SPECS_RERUN_COMMAND_SPEC_FILE_LIMIT
      PARALLEL_SPECS_PROCESSORS
      PARALLEL_SPECS_RAILS_ENV
      TEST_ENV_NUMBER
